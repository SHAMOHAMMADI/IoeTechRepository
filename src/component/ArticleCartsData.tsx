...
export const ArticleCartsData: ArticleCartsProps[] = [
  ...
  // {
  //   image: "./images/gaz detector.webp",
  //   title: "آشکارساز گاز یا دیتکتور گاز چیست و چطور عمل می کند؟",
  //   description: "",
  //   logo: "./images/logoiotech.png",
  //   date: "",
  // },
  ...
  //   title: "انواع سنسور هوشمند (آشنایی با ۸ سنسور کاملا هوشمند)",
  //   description: "",
  //   logo: "./images/logoiotech.png",
  //   date: "",
  // },
  ...
  // {
  //   image: "./images/industrial monitoring.webp",
  //   title: "مانیتورینگ صنعتی چیست و چه مزایایی برای صنایع مختلف دارد؟",
  //   description: "",
  //   logo: "./images/logoiotech.png",
  //   date: "",
  // },
  // {
  //   image: "./images/2.jpg",
  //   title: "پریز هوشمند چیست و چه کاربردی دارد؟ (۱۵ کاربرد برتر)",
  //   description: "",
  //   logo: "./images/logoiotech.png",
  //   date: "",
  // },
  // {
  //   image: "./images/3.jpg",
  //   title: "ترموستات هوشمند چیست و ۵ کاربرد اصلی آن چه هستند؟",
  //   description: "",
  //   logo: "./images/logoiotech.png",
  //   date: "",
  // },
  ...
  //   image: "./images/4.jpg",
  //   title:
  //     "گلخانه هوشمند چیست و چه امکاناتی دارد؟ (+ مزایای هوشمند کردن گلخانه)",
  //   description: "",
  //   logo: "./images/logoiotech.png",
  //   date: "",
  // },
  // {
  //   image: "./images/3.jpg",
  //   title: "هوشمند سازی استخر چیست و چه امکاناتی به استخر اضافه می کند؟",
  //   description: "",
  //   logo: "./images/logoiotech.png",
  //   date: "",
  // },
  // {
  //   image: "./images/4.jpg",
  //   title: "پارکینگ هوشمند زیربنای شهرهای مدرن",
  //   description: "",
  //   logo: "./images/logoiotech.png",
  //   date: "",
  // },
  // {
  //   image: "./images/3.jpg",
  //   title: "سیستم کنترل مرکزی و نظارت بر مرکز داده Data center monitoring",
  //   description: "",
  //   logo: "./images/logoiotech.png",
  //   date: "",
  // },
  // {
  //   image: "./images/4.jpg",
  //   title: "بیمارستان های هوشمند : سلامت عمومی دیجیتال",
  //   description: "",
  //   logo: "./images/logoiotech.png",
  //   date: "",
  // },
  // {
  //   image: "./images/3.jpg",
  //   title: "مدیریت انرژی و زمان به کمک اینترنت اشیا",
  //   description: "",
  //   logo: "./images/logoiotech.png",
  //   date: "",
  // },
  // {
  //   image: "./images/4.jpg",
  //   title: "امکانات خانه هوشمند برای کسانی که حیوان خانگی دارند",
  //   description: "",
  //   logo: "./images/logoiotech.png",
  //   date: "",
  // },
  // {
  //   image: "./images/3.jpg",
  //   title: "خانه هوشمند برای افراد دارای معلولیت و کم توان جسمی",
  //   description: "",
  //   logo: "./images/logoiotech.png",
  //   date: "",
  // },
  // {
  //   image: "./images/4.jpg",
  //   title: "هوشمند سازی خانه برای افراد مبتلا به اوتیسم",
  //   description: "",
  //   logo: "./images/logoiotech.png",
  //   date: "",
  // },
  // {
  //   image: "./images/4.jpg",
  //   title: "اینترنت اشیا (IoT) در ایران",
  //   description: "",
  //   logo: "./images/logoiotech.png",
  //   date: "",
  // },
  // {
  //   image: "./images/3.jpg",
  //   title: "آیا بلاک چین می تواند همنشین خوبی برای اینترنت اشیا باشد؟",
  //   description: "",
  //   logo: "./images/logoiotech.png",
  //   date: "",
  // },
